...
const NftGallery: React.FC<NftGalleryProps> = ({ setInstructionsVisible }) => {
  ...
  useEffect(() => {
    ...
    // === Single starry ceiling covering full 50x50 using provided image ===
    ...
    // ...rest of NftGallery implementation unchanged (decor, movement, raycasting, cleanup)...
    // [CONTENT OMITTED HERE FOR BREVITY IN EXPLANATION – your actual file keeps everything
    // exactly as in the previous working version from this point onward]
